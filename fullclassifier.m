...
predictorNames = {'entropy', 'gray_level', 'skewness', 'SNR', 'contrast', 'energy', 'correlation', 'mean', 'variance', 'SD', 'area', 'perimeter', 'majoraxislength', 'minoraxislength', 'eccentricity', 'Orientation'};
...
trainedClassifier.RequiredVariables = {'entropy', 'gray_level', 'skewness', 'SNR', 'contrast', 'energy', 'correlation', 'mean', 'variance', 'SD', 'area', 'perimeter', 'majoraxislength', 'minoraxislength', 'eccentricity', 'Orientation'};
